...
impl Slider {
    pub fn new(
        ...
        Slider(Column::start(8.0),
            ...
            interactions::Slider::new(ctx, start, Rectangle::new(colors.outline.primary, 3.0, None), Rectangle::new(colors.brand, 3.0, None), Circle::new(18.0, colors.brand, false), on_change),
        )
    }
}